    ...
    <>
      <section className="mx-auto grid max-w-7xl gap-16 px-6 py-16 lg:grid-cols-2 lg:items-center lg:gap-12 lg:px-8 lg:py-24">
        ...
        >
          ...
          <h1 className="mt-6 font-display text-4xl font-semibold leading-tight tracking-tight text-ink-900 sm:text-5xl lg:text-[3.25rem] dark:text-white">
          ...
          <div className="mt-10 flex items-center gap-8">
            <div>
              <p className="font-display text-2xl font-semibold text-ink-900 dark:text-white">12,400+</p>
              <p className="text-sm text-ink-500 dark:text-ink-400">Deliveries carried</p>
            </div>
            <div>
              <p className="font-display text-2xl font-semibold text-ink-900 dark:text-white">4.8/5</p>
              <p className="text-sm text-ink-500 dark:text-ink-400">Average traveller rating</p>
            </div>
          </div>
        </motion.div>
